            ...
            var timeCountDown = {
                    ...
                    if(_startLeftTime > 0){
            			...
            			if(_endLeftTime > 0){
                            $(v).html([
            					...
            					'<li class="item"><i class="day">'+_day+'</i><span>日</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="hour">'+_hour+'</i><span>時間</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="minute">'+_minite+'</i><span>分</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="second">'+_second+'</i><span>秒</span></li>',
                ...
                init: function(){
                    ...
                    if(new Date(opts.endtime) <= new Date(opts.starttime)){
                        throw new Error('開始時間の設定確認して下さい');
                        return false;
                    }
